      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-[#111] border border-[#1A1A1A] rounded-xl overflow-hidden">
          ...
          {athletes?.map((athlete) => (
            <a href={`/athletes/${athlete.id}`} key={athlete.id} className="grid grid-cols-4 px-6 py-4 border-b border-[#1A1A1A] hover:bg-[#141414] transition-colors cursor-pointer">
